...
/**
 * Servlet implementation class PurchaseDataServlet
 */
@WebServlet("/purchasedata.do")
public class PurchaseDataServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PurchaseDataServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/views/mypage/purchaseData/mypage_purchaseData.jsp").forward(request, response);
	}
