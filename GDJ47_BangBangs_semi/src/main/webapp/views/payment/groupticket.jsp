...
<div id="total">
	<div id="voucher">
		<nav class="nav nav-pills nav-fill">	  
			  ...
			  <a class="nav-link active" aria-current="page" href="http://localhost:9090/GDJ47_BangBangs_semi/views/payment/groupticket.jsp">단체권</a>
    ...
    <script>
	    ...
	    function comHead() {
	        ...
	        document.getElementById("TOT_AMOUNT1").value=p*o;
	    }
