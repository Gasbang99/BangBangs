...
<div id="selecttype">
	...
	<div id="selecttype1">
        ...
        <input type="number" id="mileage1" placeholder="사용할 마일리지" style="margin-left:40px" onkeyup="comPayment1();" value="0"><br><br>
       	<p style="font-weight: bold;">&nbsp;보유 마일리지 </p><input type="number" id="posseMile" readonly="readonly" style="margin-left:40px">
        <br><br>
    </div>
	<style>
...
<div id="comPaymentClsCd1">
    ...
    <div id="paybox">
        ...
        <p id="mileage2" style="border-bottom:1px solid black;border-width:2px">마일리지&nbsp;&nbsp;
